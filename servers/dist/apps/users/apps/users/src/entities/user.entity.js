...
exports.User = exports.Avatar = void 0;
...
exports.Avatar = Avatar = __decorate([(0, graphql_1.ObjectType)()], Avatar);
let User = class User {};
exports.User = User;
__decorate(
...
exports.User = User = __decorate([(0, graphql_1.ObjectType)()], User);
